...
/**
 * This is a benchmark for blocking queue implementation.
 * 
...
public class BlockingQueueBenchmark {
    ...
    private static void testQueue(final BlockingQueue<String> queue, int producerNum, final int batchSize) throws InterruptedException {
